 ...
 * </pre>
 */
public final class MiaokanBarUtils {
    ...
    public static void isHideBar(Activity context) {
        //隐藏状态栏
    ...
    public static void isDisplayBar(Activity context) {
        //显示状态栏
    ...
    public static boolean hasNotch(Context act) {
        return hasNotchAtHuawei(act) || hasNotchAtXiaoMi(act) ||
                hasNotchAtOPPO(act) || hasNotchAtVivo(act) || hasNotchP(DyApplication.Companion.getCurrentActivity());
    }
     ...
     * @return
     */
    public static boolean hasNotchAtXiaoMi(Context act) {

        int s = getInt("ro.miui.notch");
        return s == 1;
    }
