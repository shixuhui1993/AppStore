...
//    private static final String AD_SEA_KEY = "39a29dcbe7efa93617d8a4de2a02edb8";
    private static final String AD_SEA_KEY = "eac96ad59fa6a23779148cb7dfb3b6ef";
    private static final String AD_SEA_IV = "0001000100010001";
    //-----类别常数-----
    /**
    ...
    public static String encryptString(String content) {
        ...
        EasyAES ea = new EasyAES(AD_SEA_KEY, 128, AD_SEA_IV);
