...
import com.duoyou.develop.utils.java_impi.JavaScriptDownload;
...
public class WebViewActivity extends BaseCompatActivity {
    ...
    private  JavaScriptDownload scriptDownload;
    ...
    public void initView() {
        ...
        webView.addJavascriptInterface(javaScriptInterface, JAVA_IMPL_TARGET_APP);
        scriptDownload = new JavaScriptDownload(this, webView);
        webView.addJavascriptInterface(scriptDownload, JAVA_IMPL_TARGET_DOWNLOAD);
...
//        String userProtocolUrl = String.format(HttpUrlKtKt.H5_USER_PROTOCOL_URL, 2, context.getResources().getString(R.string.app_name));
//        Intent intent = new Intent(context, WebViewActivity.class);
//        intent.putExtra("url", HttpUrlKtKt.getUrlWithHost(userProtocolUrl));
//        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//        context.startActivity(intent);
//    }
